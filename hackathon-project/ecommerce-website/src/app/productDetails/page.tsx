...
import dummyproduct from '@/images/dummyproduct.png'
  ...
  return (
      ...
      <div className="flex overflow-hidden flex-col pb-12 max-md:max-w-full">
        <div className="flex overflow-hidden flex-wrap gap-8 items-start max-md:max-w-full">
          ...
          <div className="flex overflow-hidden flex-col items-start px-6 pt-3 pb-6 min-w-[240px] w-[510px] max-md:px-5 max-md:max-w-full">
            ...
            <div className="shrink-0 mt-7 max-w-full h-px border border-solid bg-stone-300 border-stone-300 w-[445px]"></div>
            <div className="flex gap-2.5 items-center mt-7">
              <div className="flex shrink-0 self-stretch my-auto bg-sky-500 rounded-full fill-sky-500 h-[30px] w-[30px]"></div>
              <div className="flex shrink-0 self-stretch my-auto bg-green-500 rounded-full fill-green-500 h-[30px] w-[30px]"></div>
              <div className="flex shrink-0 self-stretch my-auto bg-orange-400 rounded-full fill-orange-400 h-[30px] w-[30px]"></div>
              <div className="flex shrink-0 self-stretch my-auto bg-slate-800 rounded-full fill-slate-800 h-[30px] w-[30px]"></div>
            </div>
    ...
    <div className="flex overflow-hidden flex-col justify-end items-end px-20 w-full bg-neutral-50 max-md:px-5 max-md:max-w-full">
      <div className="flex overflow-hidden flex-col items-center py-12 w-full max-w-[1124px] max-md:max-w-full">
        ...
        <div className="flex mt-6 max-w-full bg-gray-200 min-h-[2px] w-[1042px]"></div>
          ...
          <div className="flex flex-col w-full sm:w-[238px]">
            <div className="flex overflow-hidden flex-col max-w-full bg-white w-full">
              ...
              <div className="flex overflow-hidden flex-col px-6 pt-6 pb-9 w-full text-base font-bold tracking-normal max-md:px-5">
                <div className="text-slate-800">Graphic Design</div>
                <div className="mt-2.5 text-sm tracking-wide leading-6 text-neutral-500">English Department</div>
